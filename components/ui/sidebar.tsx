...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-w-0 flex-1 flex-col rounded-xl bg-white shadow-md dark:bg-zinc-950",
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
        "md:peer-data-[variant=inset]:peer-data-[state=expanded]:ml-[calc(var(--sidebar-width)_+_theme(spacing.3))]",
        "md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-[calc(var(--sidebar-width-icon)]",
        className
      )}
      {...props}
    />
